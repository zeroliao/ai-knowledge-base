...
describe('Prompt_QuoteTemplateList', () => {
  ...
  it('should expose source URL in default cite templates', () => {
    expect(Prompt_QuoteTemplateList[0].value['4.9.7']).toContain('"sourceUrl": "{{sourceId}}"');
    expect(Prompt_QuoteTemplateList[2].value['4.9.7']).toContain('"sourceUrl": "{{sourceId}}"');
  });
});
