...
const MarketSourceModal = dynamic(() => import('@/pageComponents/config/market/MarketSourceModal'));
...
const ToolProvider = () => {
  ...
  const {
    isOpen: isOpenMarketSourceModal,
    onOpen: onOpenMarketSourceModal,
    onClose: onCloseMarketSourceModal
  } = useDisclosure();
  ...
  return (
    <MyBox pt={4} pl={3} pr={8} isLoading={loadingTools}>
      ...
      {isOpenMarketSourceModal && (
        <MarketSourceModal
          onClose={onCloseMarketSourceModal}
          onImportResource={() => {
            onCloseMarketSourceModal();
            onOpenImportModal();
          }}
        />
      )}
